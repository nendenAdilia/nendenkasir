...
?>
<!-- Sidebar -->
<ul class="navbar-nav -info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Toko Lia<sup></sup></div>
    </a>
    ...
    <?php if(!empty($_SESSION['admin'])&& $_SESSION['admin']['id_member']=='1'){?>
        <li class="nav-item active">
        <a class="nav-link" href="register.php?page=pengaturan">
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow"style="background: rgb(125,179,240);
background: radial-gradient(circle, rgba(125,179,240,1) 100%, rgba(238,174,174,0.8995973389355743) 100%);">

            <!-- Sidebar Toggle (Topbar) -->
            <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
            </button>
            <h5 class="d-lg-block d-none mt-2 text-white"><b><?php echo $toko['nama_toko'];?>, <?php echo $toko['alamat_toko'];?></b></h5>
            <!-- Topbar Navbar -->
