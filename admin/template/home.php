...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style="background: rgb(238,174,174);
background: radial-gradient(circle, rgba(238,174,174,0.8995973389355743) 100%, rgba(125,179,240,1) 100%);;text-white">
                <h9 class="pt-2"><i class="fas fa-list-ol"></i> Nama Barang</h9>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header"style="background: rgb(238,174,174);
background: radial-gradient(circle, rgba(238,174,174,0.8995973389355743) 100%, rgba(125,179,240,1) 100%);; text-white">
                <h9 class="pt-2"><i class="fas fa-chart-bar"></i> Stok Barang</h9>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style="background: rgb(238,174,174);
background: radial-gradient(circle, rgba(238,174,174,0.8995973389355743) 100%, rgba(125,179,240,1) 100%);;text-white">
                <h9 class="pt-2"><i class="fas fa-tasks"></i> Telah Terjual</h9>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header "style="background: rgb(238,174,174);
background: radial-gradient(circle, rgba(238,174,174,0.8995973389355743) 100%, rgba(125,179,240,1) 100%);;text-white">
                <h9 class="pt-2"><i class="fa fa-bookmark"></i> Kategori Barang</h9>
            </div>
            <div class="card-body">
                <center>
